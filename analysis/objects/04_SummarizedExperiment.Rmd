...
norm_counts <- DESeq2::estimateSizeFactors(deseq2_object) %>% DESeq2::counts(normalized = T)
...
SummarizedExperiment_object <- 
  SummarizedExperiment(assays    = 
                         list(norm_counts      = norm_counts[edb_gene_annotation$gene_id, metadata_subset$`Sample ID`],
                              log2_norm_counts = log2_norm_counts[edb_gene_annotation$gene_id, metadata_subset$`Sample ID`],
                              vst_counts       = vst_counts[edb_gene_annotation$gene_id, metadata_subset$`Sample ID`],
                              raw_counts       = tximport_object$counts[edb_gene_annotation$gene_id, metadata_subset$`Sample ID`]),
