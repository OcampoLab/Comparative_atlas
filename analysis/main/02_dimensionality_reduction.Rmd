...
pdf(file = "output/figures/PCA_plot_combined.pdf", width = 10, height = 18)
PCA_plot_combined$PC1.vs.PC2 / PCA_plot_combined$PC1.vs.PC3 / PCA_plot_combined$PC2.vs.PC3
dev.off()

pdf(file = "output/figures/PCA_plot_tissue.pdf", width = 15, height = 9)
PCA_plot_tissue
dev.off()

pdf(file = "output/figures/tSNE_plots.pdf", width = 12, height = 7)
tSNE_plots
dev.off()

pdf(file = "output/figures/UMAP_plots.pdf", width = 12, height = 7)
UMAP_plots
dev.off()
