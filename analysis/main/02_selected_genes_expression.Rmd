...
# 5. Enterocytes genes on the Small intestine data
```{r}
...
########################################
ht5 <- 
  heatmap_plot_data$Enterocytes_PanglaoDB %>% 
  filter(Tissue == "Small intestine") %>%
  dplyr::select(gene_name, Genotype, mean_log2_norm_counts) %>% 
  spread(Genotype, mean_log2_norm_counts) %>% 
  column_to_rownames("gene_name") %>% 
...
# 6. Kidney genes on the Kidney data
```{r}
...
ht6 <- 
map(list(
  "Proximal tubule cells" = heatmap_plot_data$P_tubule_cells_PanglaoDB,
  "Distal tubule cells"   = heatmap_plot_data$D_tubule_cells_PanglaoDB,
  "Podocytes"             = heatmap_plot_data$Podocytes_PanglaoDB,
  "Epithelial cells"      = heatmap_plot_data$Renal_epithelial_cells_Clark_et_al,
  "Non-epithelial cells"  = heatmap_plot_data$Renal_nonepithelial_cells_Clark_et_al), 
  function(x){
...
# 7. Heart genes on the Heart data
```{r}
...
ht7 <- 
map(list(
  "Cardiomyocytes" = heatmap_plot_data$Cardiomyocytes_PanglaoDB), 
  function(x){
...
# 8. Brain genes on the Brain data
```{r}
...
ht8 <- 
map(list(
  "Neurons"          = heatmap_plot_data$Neurons_PanglaoDB,
  "Astrocytes"       = heatmap_plot_data$Astrocytes_PanglaoDB,
  "Oligodendrocytes" = heatmap_plot_data$Oligodendrocytes_PanglaoDB), 
  function(x){
...
# 9. Skeletal muscle genes on the Skeletal muscle data
```{r}
...
ht9 <- 
map(list(
  "Myocytes" = heatmap_plot_data$Myocytes_PanglaoDB), 
  function(x){
    
  x %>% 
  filter(!gene_name %in% "Arhgap26") %>% 
...
# 10. Spleen genes on the Spleen data
```{r}
...
ht10 <- 
map(list(
  "Macrophages" = heatmap_plot_data$Macrophages_PanglaoDB), 
  function(x){
...
pdf(file = "output/figures/02_selected_genes_expression/ht5.pdf", width = 4, height = 15)
draw(ht5, heatmap_legend_side = "bottom")
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht5_scaled.pdf", width = 4, height = 15)
draw(ht5_scaled, heatmap_legend_side = "bottom")
dev.off()
...
pdf(file = "output/figures/02_selected_genes_expression/ht6_1.pdf", width = 4, height = 13)
ht6$`Proximal tubule cells` %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Proximal tubule cells"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht6_1_scaled.pdf", width = 4, height = 13)
ht6_scaled$`Proximal tubule cells` %>% 
  draw(heatmap_legend_side = "bottom", 
       row_title           = c("Proximal tubule cells"), 
       row_title_side      = "right",
       row_title_gp        = gpar(fontface = "bold")
...
# Distal tubule cells
pdf(file = "output/figures/02_selected_genes_expression/ht6_2.pdf", width = 4, height = 5)
ht6$`Distal tubule cells` %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Distal tubule cells"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht6_2_scaled.pdf", width = 4, height = 5)
ht6_scaled$`Distal tubule cells` %>% 
  draw(heatmap_legend_side = "bottom", 
       row_title           = c("Distal tubule cells"), 
       row_title_side      = "right",
       row_title_gp        = gpar(fontface = "bold")
...
# Podocytes
pdf(file = "output/figures/02_selected_genes_expression/ht6_3.pdf", width = 4, height = 16)
ht6$Podocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Podocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht6_3_scaled.pdf", width = 4, height = 16)
ht6_scaled$Podocytes %>% 
  draw(heatmap_legend_side = "bottom", 
       row_title           = c("Podocytes"), 
       row_title_side      = "right",
       row_title_gp        = gpar(fontface = "bold")
...
# Epithelial cells
pdf(file = "output/figures/02_selected_genes_expression/ht6_4.pdf", width = 4, height = 4.5)
ht6$`Epithelial cells` %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Epithelial cells"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht6_4_scaled.pdf", width = 4, height = 4.5)
ht6_scaled$`Epithelial cells` %>% 
  draw(heatmap_legend_side = "bottom", 
       row_title           = c("Epithelial cells"), 
       row_title_side      = "right",
       row_title_gp        = gpar(fontface = "bold")
...
pdf(file = "output/figures/02_selected_genes_expression/ht6_5.pdf", width = 4, height = 4.5)
ht6$`Non-epithelial cells` %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Non-epithelial cells"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht6_5_scaled.pdf", width = 4, height = 4.5)
ht6_scaled$`Non-epithelial cells` %>% 
  draw(heatmap_legend_side = "bottom", 
       row_title           = c("Non-epithelial cells"), 
       row_title_side      = "right",
       row_title_gp        = gpar(fontface = "bold")
...
# Cardiomyocytes
pdf(file = "output/figures/02_selected_genes_expression/ht7_1.pdf", width = 4, height = 15)
ht7$Cardiomyocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Cardiomyocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht7_1_scaled.pdf", width = 4, height = 15)
ht7_scaled$Cardiomyocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Cardiomyocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
...
# Neurons
pdf(file = "output/figures/02_selected_genes_expression/ht8_1.pdf", width = 4, height = 15)
ht8$Neurons %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Neurons"), 
     row_title_side      = "right",
...
pdf(file = "output/figures/02_selected_genes_expression/ht8_1_scaled.pdf", width = 4, height = 15)
ht8_scaled$Neurons %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Neurons"), 
     row_title_side      = "right",
...
# Astrocytes
pdf(file = "output/figures/02_selected_genes_expression/ht8_2.pdf", width = 4, height = 12)
ht8$Astrocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Astrocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht8_2_scaled.pdf", width = 4, height = 12)
ht8_scaled$Astrocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Astrocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
...
# Oligodendrocytes
pdf(file = "output/figures/02_selected_genes_expression/ht8_3.pdf", width = 4, height = 15)
ht8$Oligodendrocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Oligodendrocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht8_3_scaled.pdf", width = 4, height = 15)
ht8_scaled$Oligodendrocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Oligodendrocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
...
# Myocytes
pdf(file = "output/figures/02_selected_genes_expression/ht9_1.pdf", width = 4, height = 15)
ht9$Myocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Myocytes"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht9_1_scaled.pdf", width = 4, height = 15)
ht9_scaled$Myocytes %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Myocytes"), 
     row_title_side      = "right",
...
# Macrophages
pdf(file = "output/figures/02_selected_genes_expression/ht10_1.pdf", width = 3, height = 22)
ht10$Macrophages %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Macrophages"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
     )
dev.off()

pdf(file = "output/figures/02_selected_genes_expression/ht10_1_scaled.pdf", width = 3, height = 22)
ht10_scaled$Macrophages %>% 
  draw(heatmap_legend_side = "bottom", 
     row_title           = c("Macrophages"), 
     row_title_side      = "right",
     row_title_gp        = gpar(fontface = "bold")
